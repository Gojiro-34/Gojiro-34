...
<img src="https://img.shields.io/badge/Status-Still_Standing-6b0f1a?style=for-the-badge&labelColor=0d0d0d" alt="Status"/>
...
Current Region: ap-south-1 (AWS Territory)
```
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=aws,terraform,ansible,docker,kubernetes,githubactions,jenkins,prometheus,grafana,mysql,postgres,nodejs,express,react,js,html,css,cpp,py,godot&theme=dark&perline=10" />
</p>
...
- **Genichiro (Docker + CI/CD)** — containerized everything, GitHub Actions & Jenkins pipelines deploying on push
- **Guardian Ape (AWS Core Services)** — tamed VPC, EC2, RDS, S3, Lambda, CloudWatch, CloudFront
- **Isshin, the Sword Saint (Full IaC Mastery)** — Terraform, Ansible, CloudFormation, full capstone rebuild
- **Sword Saint Isshin, Phase 2 (Kubernetes + Observability)** — Docker Compose, Kubernetes basics, Prometheus + Grafana monitoring stack
